...
SFML_GameMenu::SFML_GameMenu(string menufilename, int windowWidth, int windowHeight)
{
	...
	if (inputFile.is_open())
	{
		...
		// Read the first line - background texture
		...
		if (inputFile.good())
		{
			...
			// Read the second line - game logo texture
			getline(inputFile, stringLine);
			if (inputFile.good())
			{
				// Load the texture file and set it to the sprite 
				...
				// Read the fourth line - Normal Text Fill Colour (R, G, B)
				getline(inputFile, stringLine);
				if (inputFile.good())
				{
					// Seperate them into three strings (assuming they are seperated by a whitespace)
					...
					// Read the fifth line - Normal Text Outline Colour (R, G, B)
					getline(inputFile, stringLine);
					if (inputFile.good())
					{
						// Seperate them into three strings (assuming they are seperated by a whitespace)
						...
						// Set the values to m_normalOutlineColour
						m_normalOutlineColour = sf::Color(redInt, greenInt, blueInt);

						// Read the sixth line - Highlight Text Fill Colour (R, G, B)
						getline(inputFile, stringLine);
						if (inputFile.good())
						{
							// Seperate them into three strings (assuming they are seperated by a whitespace)
							...
							// Read the seventh line - Highlight Text Outline Colour (R, G, B)
							getline(inputFile, stringLine);
							if (inputFile.good())
							{
								// Seperate them into three strings (assuming they are seperated by a whitespace)
								...
								// Read the eighth line - Border size in pixels
								getline(inputFile, stringLine);
								if (inputFile.good())
								{
									...
									// Read the ninth line - Menu Text Position 
									getline(inputFile, stringLine);
									if (inputFile.good())
									{
